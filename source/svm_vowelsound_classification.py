...
"""
param_grid = [
  {'estimator__C': [1, 10, 100, 1000, 10000], 'estimator__kernel': ['linear']},
  {'estimator__C': [1, 10, 100, 1000, 10000], 'estimator__gamma': [1e-2, 1e-3, 1e-4], 'estimator__kernel': ['rbf', 'poly']},
 ]
"""
...
param_grid = [
  ...
  {'C': [1, 10, 100, 1000, 10000], 'gamma': [1e-3, 1e-4], 'kernel': ['rbf', 'poly']},
 ]
